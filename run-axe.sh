...
echo "Running Axe CLI on $URL with axe-source $AXE_SOURCE with rules: $RULE_IDS"
...
axe "$URL" --chrome-options="headless,disable-gpu,no-sandbox,incognito" --rules "$RULE_IDS" --axe-source ./axe.js --verbose --exit